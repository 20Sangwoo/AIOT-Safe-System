...
특히 노약자, 어린이, 청각 또는 시각에 불편함을 가지고 계신 분들 등, 갑작스런 재난에 더욱 취약한 계층도 큰 어려움과 <br>
...
각 센서와 세이프워치는 nodeMCU를 통해 WIFI로 인터넷 연결을 하고<br>
...
작은 IoT 장치에 적합하다고 생각해 이용했습니다.<br><br>

1. 추가 대처 방안 : 음성 메시지, 스마트폰 앱과 연동도 생각 중임 <br><br>

2. 전력 소비 문제 : m5는 휴대폰처럼 충전 가능, 센서들은 집의 콘센트나 전지 소켓을 활용 및 배터리 용량 체크 가능하도록 보완<br><br>

3. 더 많은 기능이나 사용자를 위한 확장 : 음성이랑 스마트폰 앱으로 확장, UI 편의성 개선 등의 계획이 있음<br>
  wifi 스캔 기능으로 자동 연결로 원활한 이용 가능하게 할 계획
